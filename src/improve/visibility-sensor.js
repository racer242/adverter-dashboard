...
import isVisibleWithOffset from "./lib/is-visible-with-offset.js";
...
export default class VisibilitySensor extends React.Component {
  ...
  componentDidMount() {
    if (!this.props.childRef) return;
    this.node = this.props.childRef.current;//ReactDOM.findDOMNode(this);
