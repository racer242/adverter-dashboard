(function(cjs, an) {
 ...
 (lib.content = function(mode, startPosition, loop) {
  ...
  this.instance_2._off = true;
  this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(211).to({
   _off: false
  }, 0).wait(85));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(96).to({
   alpha: 0
  }, 14, cjs.Ease.get(1)).wait(85).to({
   regY: 300.1,
   y: 300.1,
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(226).to({
   _off: false
  }, 0).to({
   alpha: 1
  ...
  var mask = new cjs.Shape();
  mask._off = true;
  var mask_graphics_216 = new cjs.Graphics().p("AOfH1QgTgTAAgcQAAgbATgTQATgUAcAAQAbAAATAUQATATAAAbQAAAcgTATQgTATgbAAQgcAAgTgTg");
  var mask_graphics_217 = new cjs.Graphics().p("ANkH+QghghAAgwQAAgvAhghQAhgiAwAAQAvAAAhAiQAiAhAAAvQAAAwgiAhQghAigvAAQgwAAghgig");
  var mask_graphics_218 = new cjs.Graphics().p("AMtIHQgugvAAhBQAAhCAugvQAvguBCAAQBCAAAuAuQAvAvAABCQAABBgvAvQguAvhCAAQhCAAgvgvg");
  var mask_graphics_219 = new cjs.Graphics().p("AL7IPQg6g7AAhTQAAhSA6g7QA7g7BTAAQBTAAA6A7QA7A7AABSQAABTg7A7Qg6A7hTAAQhTAAg7g7g");
  var mask_graphics_220 = new cjs.Graphics().p("ALNIWQhFhFAAhjQAAhiBFhGQBGhFBiAAQBjAABFBFQBGBGAABiQAABjhGBFQhFBGhjAAQhiAAhGhGg");
  var mask_graphics_221 = new cjs.Graphics().p("AKkIdQhQhQAAhwQAAhxBQhPQBPhQBxAAQBwAABQBQQBQBPAABxQAABwhQBQQhQBQhwAAQhxAAhPhQg");
  var mask_graphics_222 = new cjs.Graphics().p("AJ/IjQhZhZAAh9QAAh9BZhYQBYhZB9AAQB9AABZBZQBYBYAAB9QAAB9hYBZQhZBYh9AAQh9AAhYhYg");
  var mask_graphics_223 = new cjs.Graphics().p("AJeIoQhhhgAAiJQAAiIBhhgQBghgCJAAQCIAABgBgQBhBgAACIQAACJhhBgQhgBgiIAAQiJAAhghgg");
  var mask_graphics_224 = new cjs.Graphics().p("AJBItQhnhnAAiSQAAiSBnhoQBohmCSAAQCSAABnBmQBnBoAACSQAACShnBnQhnBniSAAQiSAAhohng");
  var mask_graphics_225 = new cjs.Graphics().p("AIpIxQhthtAAibQAAiaBthtQBthsCaAAQCbAABtBsQBsBtAACaQAACbhsBtQhtBsibAAQiaAAhthsg");
  var mask_graphics_226 = new cjs.Graphics().p("AIWI0QhyhyAAihQAAihByhxQBxhxChAAQChAAByBxQBxBxAAChQAAChhxByQhyBxihAAQihAAhxhxg");
  var mask_graphics_227 = new cjs.Graphics().p("AIGI2Qh1h1AAimQAAimB1h1QB2h1CmAAQCmAAB1B1QB1B1AACmQAACmh1B1Qh1B1imAAQimAAh2h1g");
  var mask_graphics_228 = new cjs.Graphics().p("AH8I4Qh4h4AAiqQAAipB4h3QB3h4CqAAQCqAAB4B4QB4B3AACpQAACqh4B4Qh4B4iqAAQiqAAh3h4g");
  var mask_graphics_229 = new cjs.Graphics().p("AH1I5Qh6h6AAisQAAirB6h5QB6h5CrAAQCsAAB6B5QB5B5AACrQAACsh5B6Qh6B5isAAQirAAh6h5g");
  var mask_graphics_230 = new cjs.Graphics().p("AHzI5Qh6h6AAitQAAisB6h5QB6h6CsAAQCtAAB6B6QB6B5AACsQAACth6B6Qh6B6itAAQisAAh6h6g");
  ...
  this.instance_7.setTransform(200.7, 97.1, 0.5883, 0.5883, 0, 0, 0, 72.6, 73.3);
  ...
  var mask_1 = new cjs.Shape();
  mask_1._off = true;
  var mask_1_graphics_116 = new cjs.Graphics().p("APkF9QgUgVAAgcQAAgdAUgVQAVgUAdAAQAdAAAUAUQAUAVAAAdQAAAcgUAVQgUAUgdAAQgdAAgVgUg");
  var mask_1_graphics_117 = new cjs.Graphics().p("AOhGIQglglAAg0QAAg0AlglQAlgkA0AAQA0AAAkAkQAlAlAAA0QAAA0glAlQgkAlg0AAQg0AAglglg");
  var mask_1_graphics_118 = new cjs.Graphics().p("ANiGSQg0gzAAhKQAAhJA0g0QA0g0BJAAQBKAAA0A0QA0A0AABJQAABKg0AzQg0A0hKAAQhJAAg0g0g");
  var mask_1_graphics_119 = new cjs.Graphics().p("AMoGcQhBhCAAhdQAAhdBBhCQBChCBdAAQBdAABCBCQBCBCAABdQAABdhCBCQhCBChdAAQhdAAhChCg");
  var mask_1_graphics_120 = new cjs.Graphics().p("AL0GlQhPhPAAhvQAAhvBPhPQBOhNBvAAQBvAABPBNQBPBPAABvQAABvhPBPQhPBOhvAAQhvAAhOhOg");
  var mask_1_graphics_121 = new cjs.Graphics().p("ALEGtQhahaAAiAQAAh/BahZQBahaB/AAQCAAABaBaQBaBZAAB/QAACAhaBaQhaBaiAAAQh/AAhahag");
  var mask_1_graphics_122 = new cjs.Graphics().p("AKZG0QhkhlAAiOQAAiOBkhjQBlhkCOAAQCOAABkBkQBkBjAACOQAACOhkBlQhkBkiOAAQiOAAhlhkg");
  var mask_1_graphics_123 = new cjs.Graphics().p("AJ0G6QhuhtAAibQAAibBuhsQBthuCbAAQCbAABtBuQBuBsAACbQAACbhuBtQhtBtibAAQibAAhthtg");
  var mask_1_graphics_124 = new cjs.Graphics().p("AJTG/Qh1h1AAimQAAilB1h1QB1h1CmAAQCmAAB2B1QB1B1AAClQAACmh1B1Qh2B2imAAQimAAh1h2g");
  var mask_1_graphics_125 = new cjs.Graphics().p("AI4HEQh8h8AAivQAAivB8h8QB8h8CvAAQCvAAB8B8QB8B8AACvQAACvh8B8Qh8B8ivAAQivAAh8h8g");
  var mask_1_graphics_126 = new cjs.Graphics().p("AIhHIQiBiCAAi3QAAi2CBiBQCBiCC3AAQC4AACBCCQCBCBAAC2QAAC3iBCCQiBCBi4AAQi3AAiBiBg");
  var mask_1_graphics_127 = new cjs.Graphics().p("AIPHLQiFiGAAi9QAAi8CFiGQCGiFC9AAQC9AACGCFQCGCGAAC8QAAC9iGCGQiGCFi9AAQi9AAiGiFg");
  var mask_1_graphics_128 = new cjs.Graphics().p("AIDHNQiJiJAAjBQAAjBCJiIQCJiJDBAAQDBAACJCJQCJCIAADBQAADBiJCJQiJCIjBAAQjBAAiJiIg");
  var mask_1_graphics_129 = new cjs.Graphics().p("AH7HOQiKiLAAjDQAAjDCKiLQCLiKDEAAQDEAACKCKQCLCLAADDQAADDiLCLQiKCKjEAAQjEAAiLiKg");
  var mask_1_graphics_130 = new cjs.Graphics().p("AH5HOQiLiLAAjFQAAjDCLiLQCLiLDFAAQDFAACLCLQCLCLAADDQAADFiLCLQiLCLjFAAQjFAAiLiLg");
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(96).to({
   _off: false
  }, 0).to({
   alpha: 1
  }, 14, cjs.Ease.get(1)).to({
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(11).to({
   _off: false
  }, 0).to({
   regX: 114,
   x: 251.95,
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_19).wait(36).to({
   _off: false
  }, 0).to({
   alpha: 1
  }, 14, cjs.Ease.get(1)).to({
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(16).to({
   _off: false
  }, 0).to({
   regX: 150.1,
   regY: 149,
