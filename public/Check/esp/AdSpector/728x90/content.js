(function(cjs, an) {
 ...
 (lib.t1 = function(mode, startPosition, loop) {
  this.initialize(mode, startPosition, loop, {});
  this.shape = new cjs.Shape();
  this.shape.graphics.f("#0C593C").s().p("AgKA6IAAgWIASAAIAAAWgAgIAXIAAgCIAAgIIADgIQACgFADgDIAGgGIAEgHQACgEAAgFIgBgGQgBgDgDgDIgCgCIgFgBIgDABIgDACQgDADgCAFQgBAFABAFIgSAAIAAgIIADgMQACgFAEgFQAFgFAGgBIAJgCIALACQAGACAGAFQADADACAFQACAGAAAJIgBAJQgBAFgEAFIgDAEIgEADIgFAFIgFAHQgBADAAAEIAAADg");
  this.shape.setTransform(510.8667, 50.675);
  this.shape_1 = new cjs.Shape();
  this.shape_1.graphics.f("#0C593C").s().p("AAYAoIAAhQIARAAIAABQgAgoAoIAAhQIARAAIAAAgIAPAAIAIAAQAEABAEADQADADACAEQACAFAAAHQAAAJgCAFQgCAEgDADQgEADgEABIgHAAgAgXAcIAJAAIAFgBQACAAACgDIACgDIABgGIAAgEQgBgDgCgCIgEgCIgEgBIgKAAg");
  this.shape_1.setTransform(501.775, 52.4);
  this.shape_2 = new cjs.Shape();
  this.shape_2.graphics.f("#0C593C").s().p("AgdApIgDgBIAAgNQAFABACgBQADgCACgDQABgCABgEIABgLIAAgSIAAgbIAyAAIAABQIgSAAIAAhDIgPAAIAAAPIAAANIgBAIIAAAFQgBAIgCAFQgCAFgDADQgDADgEABQgEACgGAAIgDAAg");
  this.shape_2.setTransform(492.225, 52.425);
  this.shape_3 = new cjs.Shape();
  this.shape_3.graphics.f("#0C593C").s().p("AgMA3IgFAAIgFAAIAAgOIADABIADAAQAEAAACgCQADgDABgFIACgHIgehQIATAAIASA6IAAAAIAPg6IARAAIgZBXIgCAIIgFAJQgDAEgDABIgGACIgDgBg");
  this.shape_3.setTransform(485.225, 53.9063);
  this.shape_4 = new cjs.Shape();
  this.shape_4.graphics.f("#0C593C").s().p("");
  this.shape_4.setTransform(477.875, 52.3833);
  this.shape_5 = new cjs.Shape();
  this.shape_5.graphics.f("#0C593C").s().p("AANAoIAAhCIgZAAIAABCIgRAAIAAhQIA7AAIAABQg");
  this.shape_5.setTransform(469.825, 52.4);
  this.shape_6 = new cjs.Shape();
  this.shape_6.graphics.f("#0C593C").s().p("");
  this.shape_6.setTransform(461.825, 52.325);
  this.shape_7 = new cjs.Shape();
  this.shape_7.graphics.f("#0C593C").s().p("AAKAoIgVgnIAAAnIgSAAIAAhQIASAAIAAAiIAUgiIATAAIgaAmIAcAqg");
  this.shape_7.setTransform(454.825, 52.4);
  this.shape_8 = new cjs.Shape();
  this.shape_8.graphics.f("#0C593C").s().p("");
  this.shape_8.setTransform(442.7, 50.675);
  this.shape_9 = new cjs.Shape();
  this.shape_9.graphics.f("#0C593C").s().p("AgMA3IgFAAIgFAAIAAgOIADABIADAAQAEAAACgCQADgDABgFIACgHIgehQIATAAIASA6IAAAAIAPg6IARAAIgZBXIgCAIIgFAJQgDAEgDABIgGACIgDgBg");
  this.shape_9.setTransform(430.925, 53.9063);
  this.shape_10 = new cjs.Shape();
  this.shape_10.graphics.f("#0C593C").s().p("");
  this.shape_10.setTransform(423.5833, 52.3833);
  this.shape_11 = new cjs.Shape();
  this.shape_11.graphics.f("#0C593C").s().p("");
  this.shape_11.setTransform(416.075, 52.325);
  this.shape_12 = new cjs.Shape();
  this.shape_12.graphics.f("#0C593C").s().p("");
  this.shape_12.setTransform(408.075, 53.7);
  this.shape_13 = new cjs.Shape();
  this.shape_13.graphics.f("#0C593C").s().p("");
  this.shape_13.setTransform(399.775, 52.3833);
  this.shape_14 = new cjs.Shape();
  this.shape_14.graphics.f("#0C593C").s().p("");
  this.shape_14.setTransform(516.95, 33.8813);
  this.shape_15 = new cjs.Shape();
  this.shape_15.graphics.f("#0C593C").s().p("AgIApIAAhEIgVAAIAAgMIA8AAIAAAMIgXAAIAABEg");
  this.shape_15.setTransform(510.65, 33.9);
  this.shape_16 = new cjs.Shape();
  this.shape_16.graphics.f("#0C593C").s().p("");
  this.shape_16.setTransform(504.35, 33.8813);
  this.shape_17 = new cjs.Shape();
  this.shape_17.graphics.f("#0C593C").s().p("");
  this.shape_17.setTransform(497.375, 33.825);
  this.shape_18 = new cjs.Shape();
  this.shape_18.graphics.f("#0C593C").s().p("AAYApIAAgzIAAgIIAAAAIgRA7IgNAAIgRg7IAAAAIAAAIIAAAzIgRAAIAAhQIAWAAIASA7IASg7IAXAAIAABQg");
  this.shape_18.setTransform(489.15, 33.9);
  this.shape_19 = new cjs.Shape();
  this.shape_19.graphics.f("#0C593C").s().p("AAOApIAAg6IgaA6IgTAAIAAhQIASAAIAAA4IAag4IASAAIAABQg");
  this.shape_19.setTransform(480.6, 33.9);
  this.shape_20 = new cjs.Shape();
  this.shape_20.graphics.f("#0C593C").s().p("AAMApIAAgkIgXAAIAAAkIgSAAIAAhQIASAAIAAAfIAXAAIAAgfIASAAIAABQg");
  this.shape_20.setTransform(473.225, 33.9);
  this.shape_21 = new cjs.Shape();
  this.shape_21.graphics.f("#0C593C").s().p("AAOApIAAg6IgZA6IgTAAIAAhQIARAAIAAA4IAZg4IAUAAIAABQg");
  this.shape_21.setTransform(465.8, 33.9);
  this.shape_22 = new cjs.Shape();
  this.shape_22.graphics.f("#0C593C").s().p("");
  this.shape_22.setTransform(458.375, 35.2);
  this.shape_23 = new cjs.Shape();
  this.shape_23.graphics.f("#0C593C").s().p("AANApIAAhEIgZAAIAABEIgRAAIAAhQIA7AAIAABQg");
  this.shape_23.setTransform(450.675, 33.9);
  this.shape_24 = new cjs.Shape();
  this.shape_24.graphics.f("#0C593C").s().p("");
  this.shape_24.setTransform(440.2, 33.875);
  this.shape_25 = new cjs.Shape();
  this.shape_25.graphics.f("#0C593C").s().p("AAMApIAAgkIgXAAIAAAkIgSAAIAAhQIASAAIAAAfIAXAAIAAgfIASAAIAABQg");
  this.shape_25.setTransform(432.975, 33.9);
  this.shape_26 = new cjs.Shape();
  this.shape_26.graphics.f("#0C593C").s().p("AAKApIAAghIgGAAIgGAAIgIAAQgFAAgDgCIgEgEIgEgFIgBgFIAAgFIAAgaIASAAIAAAVIAAAGIACAEQACADADABIAFABIADAAIAEgBIAAgjIARAAIAABQg");
  this.shape_26.setTransform(425.95, 33.9);
  this.shape_27 = new cjs.Shape();
  this.shape_27.graphics.f("#0C593C").s().p("AAYApIAAhQIARAAIAABQgAgoApIAAhQIARAAIAAAeIAPAAIAIABQAEABAEADQADADACAEQACAFAAAIQAAAHgCAFQgCAFgDADQgEADgEABIgHABgAgXAbIAJAAIAFAAQACAAACgCIACgEIABgGIAAgFQgBgCgCgCIgEgCIgEAAIgKAAg");
  this.shape_27.setTransform(418.125, 33.9);
  this.shape_28 = new cjs.Shape();
  this.shape_28.graphics.f("#0C593C").s().p("");
  this.shape_28.setTransform(409.65, 32.2036);
  this.shape_29 = new cjs.Shape();
  this.shape_29.graphics.f("#0C593C").s().p("");
  this.shape_29.setTransform(401.025, 32.35);
  this.shape_30 = new cjs.Shape();
  this.shape_30.graphics.f("#0C593C").s().p("AARAwIAAhEIgfBEIgXAAIAAhfIAVAAIAABEIAfhEIAXAAIAABfg");
  this.shape_30.setTransform(311.625, 51.075);
  this.shape_31 = new cjs.Shape();
  this.shape_31.graphics.f("#0C593C").s().p("AARAwIAAhEIgfBEIgXAAIAAhfIAVAAIAABEIAfhEIAXAAIAABfg");
  this.shape_31.setTransform(302.175, 51.075);
  this.shape_32 = new cjs.Shape();
  this.shape_32.graphics.f("#0C593C").s().p("AAPAwIAAgrIgcAAIAAArIgVAAIAAhfIAVAAIAAAmIAcAAIAAgmIAUAAIAABfg");
  this.shape_32.setTransform(292.975, 51.075);
  this.shape_33 = new cjs.Shape();
  this.shape_33.graphics.f("#0C593C").s().p("");
  this.shape_33.setTransform(284.225, 51);
  this.shape_34 = new cjs.Shape();
  this.shape_34.graphics.f("#0C593C").s().p("");
  this.shape_34.setTransform(275.825, 51.075);
  this.shape_35 = new cjs.Shape();
  this.shape_35.graphics.f("#0C593C").s().p("");
  this.shape_35.setTransform(266.775, 51.075);
  this.shape_36 = new cjs.Shape();
  this.shape_36.graphics.f("#0C593C").s().p("");
  this.shape_36.setTransform(258.1, 51.075);
  this.shape_37 = new cjs.Shape();
  this.shape_37.graphics.f("#0C593C").s().p("");
  this.shape_37.setTransform(249.825, 51);
  this.shape_38 = new cjs.Shape();
  this.shape_38.graphics.f("#0C593C").s().p("");
  this.shape_38.setTransform(241.025, 52.625);
  this.shape_39 = new cjs.Shape();
  this.shape_39.graphics.f("#0C593C").s().p("");
  this.shape_39.setTransform(231.425, 49.075);
  this.shape_40 = new cjs.Shape();
  this.shape_40.graphics.f("#0C593C").s().p("");
  this.shape_40.setTransform(222.025, 51.075);
  this.shape_41 = new cjs.Shape();
  this.shape_41.graphics.f("#0C593C").s().p("");
  this.shape_41.setTransform(212.925, 51.075);
  this.shape_42 = new cjs.Shape();
  this.shape_42.graphics.f("#0C593C").s().p("");
  this.shape_42.setTransform(204.25, 51.075);
  this.shape_43 = new cjs.Shape();
  this.shape_43.graphics.f("#0C593C").s().p("");
  this.shape_43.setTransform(195.975, 51);
  this.shape_44 = new cjs.Shape();
  this.shape_44.graphics.f("#0C593C").s().p("AgbAwIAAhfIA3AAIAAAPIgjAAIAABQg");
  this.shape_44.setTransform(188.95, 51.075);
  this.shape_45 = new cjs.Shape();
  this.shape_45.graphics.f("#0C593C").s().p("AARAwIAAhEIgfBEIgXAAIAAhfIAVAAIAABEIAfhEIAXAAIAABfg");
  this.shape_45.setTransform(287.775, 32.925);
  this.shape_46 = new cjs.Shape();
  this.shape_46.graphics.f("#0C593C").s().p("AARAwIAAhEIgfBEIgXAAIAAhfIAVAAIAABEIAfhEIAXAAIAABfg");
  this.shape_46.setTransform(274.175, 32.925);
  this.shape_47 = new cjs.Shape();
  this.shape_47.graphics.f("#0C593C").s().p("AARAwIAAhEIgfBEIgXAAIAAhfIAVAAIAABEIAfhEIAXAAIAABfg");
  this.shape_47.setTransform(264.725, 32.925);
  this.shape_48 = new cjs.Shape();
  this.shape_48.graphics.f("#0C593C").s().p("AgJAwIAAhQIgaAAIAAgPIBHAAIAAAPIgaAAIAABQg");
  this.shape_48.setTransform(256.55, 32.925);
  this.shape_49 = new cjs.Shape();
  this.shape_49.graphics.f("#0C593C").s().p("AgUBCIgGgBIAAgQIADABIAEABQAFgBACgDQAEgDABgFIACgJIgjhfIAXAAIAUBFIABAAIARhFIAUAAIgdBoIgDAJIgGAKQgDAFgEABQgFACgFAAIgGAAg");
  this.shape_49.setTransform(249.15, 34.725);
  this.shape_50 = new cjs.Shape();
  this.shape_50.graphics.f("#0C593C").s().p("AAdA9IAAgZIg5AAIAAAZIgSAAIgCgpIALAAIAEgIIADgKQAEgMABgLIAAgWIAAgRIA8AAIAABQIAOAAIgCApgAgGggIAAAMIgCANIgDANIgFAOIAeAAIAAhAIgUAAg");
  this.shape_50.setTransform(240.475, 34.175);
  this.shape_51 = new cjs.Shape();
  this.shape_51.graphics.f("#0C593C").s().p("");
  this.shape_51.setTransform(231.7, 32.925);
  this.shape_52 = new cjs.Shape();
  this.shape_52.graphics.f("#0C593C").s().p("");
  this.shape_52.setTransform(223.625, 32.925);
  this.shape_53 = new cjs.Shape();
  this.shape_53.graphics.f("#0C593C").s().p("AARAwIAAhEIgfBEIgXAAIAAhfIAVAAIAABEIAfhEIAXAAIAABfg");
  this.shape_53.setTransform(210.275, 32.925);
  this.shape_54 = new cjs.Shape();
  this.shape_54.graphics.f("#0C593C").s().p("");
  this.shape_54.setTransform(201.075, 34.475);
  this.shape_55 = new cjs.Shape();
  this.shape_55.graphics.f("#0C593C").s().p("AAVBCIAAhvIgpAAIAABvIgWAAIAAiDIBWAAIAACDg");
  this.shape_55.setTransform(190.65, 31.1);
  this.timeline.addTween(cjs.Tween.get({}).to({
   state: [{
    t: this.shape_55
   }, {
 ...
 }).prototype = getMCSymbolPrototype(lib.t1, new cjs.Rectangle(183, 18, 480, 45.3), null);
 ...
 (lib.txt01 = function(mode, startPosition, loop) {
  ...
  var mask = new cjs.Shape();
  mask._off = true;
  mask.graphics.p("ADNHUIAAn0MAtKAAAIAAH0g");
  mask.setTransform(309.4969, 46.75);
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance).wait(25).to({
   _off: false
  }, 0).to({
   x: 108,
   alpha: 1
  ...
  var mask_1 = new cjs.Shape();
  mask_1._off = true;
  mask_1.graphics.p("ADND6IAAnzMAtKAAAIAAHzg");
  mask_1.setTransform(309.4969, 18.5);
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(20).to({
   _off: false
  }, 0).to({
   x: 108,
   alpha: 1
  ...
  var mask_2 = new cjs.Shape();
  mask_2._off = true;
  mask_2.graphics.p("AxaHLIAAnzMAqpAAAIAAHzg");
  mask_2.setTransform(161.4967, 45.875);
  ...
  mask_3._off = true;
  mask_3.graphics.p("AxaD6IAAnzMAqpAAAIAAHzg");
  mask_3.setTransform(161.4967, 16.75);
 ...
 p.nominalBounds = new cjs.Rectangle(153, 18, 466, 45.3);
 ...
 (lib.content = function(mode, startPosition, loop) {
  ...
  var mask_2 = new cjs.Shape();
  mask_2._off = true;
  var mask_2_graphics_30 = new cjs.Graphics().p("EAqtAENQgLgMAAgPQAAgQALgLQAMgLAPAAQAQAAALALQALALAAAQQAAAPgLAMQgLALgQAAQgPAAgMgLg");
  var mask_2_graphics_31 = new cjs.Graphics().p("EAqBAEUQgWgWAAggQAAgfAWgWQAWgWAfAAQAfAAAWAWQAWAWAAAfQAAAggWAWQgWAWgfAAQgfAAgWgWg");
  var mask_2_graphics_32 = new cjs.Graphics().p("EApXAEaQggggAAgtQAAguAgggQAgggAuAAQAtAAAgAgQAgAgAAAuQAAAtggAgQggAggtAAQguAAggggg");
  var mask_2_graphics_33 = new cjs.Graphics().p("EAoxAEgQgpgpAAg7QAAg6ApgqQApgpA7AAQA6AAApApQAqAqAAA6QAAA7gqApQgpApg6AAQg7AAgpgpg");
  var mask_2_graphics_34 = new cjs.Graphics().p("EAoOAElQgygxAAhHQAAhGAygyQAygyBGAAQBHAAAxAyQAyAyAABGQAABHgyAxQgxAyhHAAQhGAAgygyg");
  var mask_2_graphics_35 = new cjs.Graphics().p("EAnvAEqQg6g5AAhRQAAhSA6g5QA5g5BRAAQBRAAA6A5QA5A5AABSQAABRg5A5Qg6A6hRAAQhRAAg5g6g");
  var mask_2_graphics_36 = new cjs.Graphics().p("EAnSAEvQhAhBAAhbQAAhaBAhAQBBhABbAAQBaAABBBAQBABAAABaQAABbhABBQhBBAhaAAQhbAAhBhAg");
  var mask_2_graphics_37 = new cjs.Graphics().p("EAm5AEyQhGhGAAhjQAAhkBGhFQBHhGBjAAQBkAABGBGQBGBFAABkQAABjhGBGQhGBHhkAAQhjAAhHhHg");
  var mask_2_graphics_38 = new cjs.Graphics().p("EAmkAE2QhMhMAAhrQAAhqBMhLQBLhMBrAAQBrAABMBMQBLBLAABqQAABrhLBMQhMBLhrAAQhrAAhLhLg");
  var mask_2_graphics_39 = new cjs.Graphics().p("EAmSAE5QhQhQAAhxQAAhyBQhPQBQhQBxAAQBxAABQBQQBQBPAAByQAABxhQBQQhQBQhxAAQhxAAhQhQg");
  var mask_2_graphics_40 = new cjs.Graphics().p("EAmDAE7QhUhUAAh2QAAh1BUhUQBThTB3AAQB2AABTBTQBUBUAAB1QAAB2hUBUQhTBUh2AAQh3AAhThUg");
  var mask_2_graphics_41 = new cjs.Graphics().p("EAl3AE9QhWhXAAh6QAAh5BWhXQBWhWB7AAQB6AABWBWQBXBXAAB5QAAB6hXBXQhWBWh6AAQh7AAhWhWg");
  var mask_2_graphics_42 = new cjs.Graphics().p("EAlvAE+QhZhYAAh9QAAh9BZhYQBYhYB9AAQB9AABZBYQBYBYAAB9QAAB9hYBYQhZBZh9AAQh9AAhYhZg");
  var mask_2_graphics_43 = new cjs.Graphics().p("EAlqAE/QhahaAAh/QAAh9BahaQBZhaB/AAQB/AABaBaQBZBaAAB9QAAB/hZBaQhaBZh/AAQh/AAhZhZg");
  var mask_2_graphics_44 = new cjs.Graphics().p("EAlnAFAQhahaAAiAQAAh+BahaQBahaCAAAQB/AABaBaQBaBaAAB+QAACAhaBaQhaBah/AAQiAAAhahag");
  ...
  this.instance_23.setTransform(550, 47.05, 0.4385, 0.4382, 0, 0, 0, 58.1, 58.6);
  ...
  this.instance_24.setTransform(556.75, 54.4, 0.0335, 0.0335, 0, 0, 0, 153.8, 153.8);
  ...
  var mask_3 = new cjs.Shape();
  mask_3._off = true;
  var mask_3_graphics_10 = new cjs.Graphics().p("AbQEJQgIgIAAgMQAAgMAIgIQAJgJALAAQAMAAAJAJQAIAIAAAMQAAAMgIAIQgJAIgMAAQgLAAgJgIg");
  var mask_3_graphics_11 = new cjs.Graphics().p("AalEQQgSgTAAgaQAAgbASgSQATgTAbAAQAaAAATATQASASAAAbQAAAagSATQgTATgaAAQgbAAgTgTg");
  var mask_3_graphics_12 = new cjs.Graphics().p("AZ+EWQgdgcAAgoQAAgoAdgcQAcgcAoAAQAoAAAcAcQAcAcAAAoQAAAogcAcQgcAdgoAAQgoAAgcgdg");
  var mask_3_graphics_13 = new cjs.Graphics().p("AZZEcQglglAAg0QAAg1AlglQAlglA1AAQA0AAAlAlQAlAlAAA1QAAA0glAlQglAlg0AAQg1AAglglg");
  var mask_3_graphics_14 = new cjs.Graphics().p("AY4EiQgtgtAAhAQAAhAAtgtQAtgtBAAAQBAAAAtAtQAtAtAABAQAABAgtAtQgtAthAAAQhAAAgtgtg");
  var mask_3_graphics_15 = new cjs.Graphics().p("AYZEnQg0g1AAhKQAAhKA0g0QA1g0BKAAQBKAAA1A0QA0A0AABKQAABKg0A1Qg1A0hKAAQhKAAg1g0g");
  var mask_3_graphics_16 = new cjs.Graphics().p("AX+ErQg7g7ABhTQgBhUA7g6QA7g6BUAAQBTAAA7A6QA7A6AABUQAABTg7A7Qg7A7hTAAQhUAAg7g7g");
  var mask_3_graphics_17 = new cjs.Graphics().p("AXnEvQhBhBAAhbQAAhcBBg/QBAhBBcAAQBbAABBBBQBBA/AABcQAABbhBBBQhBBBhbAAQhcAAhAhBg");
  var mask_3_graphics_18 = new cjs.Graphics().p("AXSEyQhGhFAAhjQAAhiBGhFQBGhGBiAAQBjAABFBGQBGBFAABiQAABjhGBFQhFBGhjAAQhiAAhGhGg");
  var mask_3_graphics_19 = new cjs.Graphics().p("AXAE1QhJhKAAhoQAAhpBJhJQBKhJBpAAQBoAABKBJQBKBJAABpQAABohKBKQhKBKhoAAQhpAAhKhKg");
  var mask_3_graphics_20 = new cjs.Graphics().p("AWyE4QhNhOAAhtQAAhuBNhMQBNhNBuAAQBtAABOBNQBNBMAABuQAABthNBOQhOBNhtAAQhuAAhNhNg");
  var mask_3_graphics_21 = new cjs.Graphics().p("AWnE5QhQhQAAhxQAAhxBQhPQBQhQBxAAQBxAABQBQQBQBPAABxQAABxhQBQQhQBQhxAAQhxAAhQhQg");
  var mask_3_graphics_22 = new cjs.Graphics().p("AWfE7QhShSAAh0QAAh0BShRQBShSB0AAQB0AABSBSQBSBRAAB0QAAB0hSBSQhSBSh0AAQh0AAhShSg");
  var mask_3_graphics_23 = new cjs.Graphics().p("AWaE7QhThTAAh1QAAh1BThTQBThTB2AAQB1AABTBTQBUBTAAB1QAAB1hUBTQhTBUh1AAQh2AAhThUg");
  var mask_3_graphics_24 = new cjs.Graphics().p("AWZE8QhThTAAh3QAAh1BThTQBThTB2AAQB3AABTBTQBTBTAAB1QAAB3hTBTQhTBTh3AAQh2AAhThTg");
  ...
  this.instance_25.setTransform(363.25, 58.9, 0.5114, 0.5104, 0, 0, 0, 72.5, 72.1);
  ...
  this.instance_26.setTransform(355.7, 52.1, 0.0263, 0.0263, 0, 0, 0, 150, 151.9);
  ...
  this.instance_27.setTransform(249.05, 42.2, 0.0315, 0.0315, 0, 0, 0, 150.8, 149.2);
  ...
  this.instance_28.setTransform(452.55, 29.55, 0.0503, 0.0503, 0, 0, 0, 152, 151);
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_29).wait(455));
 }).prototype = p = new cjs.MovieClip();
 p.nominalBounds = new cjs.Rectangle(-3, -72.3, 881, 220.8);
