(function(cjs, an) {
 ...
 p.nominalBounds = new cjs.Rectangle(0, 0, 215, 288);
 (lib.legal_01 = function(mode, startPosition, loop) {
  ...
  this.cvr_d1.setTransform(18, 56, 0.5, 0.5);
  this.initialize(mode, startPosition, loop, {
   cvr_frame01: 65,
   cvr_frame02: 195
  });
  ...
  mask_cvr_d1.setTransform(127.5, 146, 2.19, 1.8);
  this.cvr_d1.mask = mask_cvr_d1
  this.timeline.addTween(cjs.Tween.get(this.cvr_d1).wait(1));
 }).prototype = getMCSymbolPrototype(lib.legal_01, new cjs.Rectangle(16, 54, 219, 183.1), null);
 ...
 (lib.black_plate = function(mode, startPosition, loop) {
  this.initialize(mode, startPosition, loop, {});
  this.shape = new cjs.Shape();
  this.shape.graphics.f("#282830").s().p("AzhTiMAAAgnDMAnDAAAMAAAAnDg");
 ...
 (lib.scaled = function(mode, startPosition, loop) {
  ...
  this.instance_7.setTransform(-23.45, 38.55, 0.23, 0.23, 0, 0, 0, 41.6, 124.2);
  ...
  this.instance_10.setTransform(-108, 245.5, 1, 1, 0, 0, 180, 100, 1.5);
  ...
  this.instance_11.setTransform(414, 118.5, 1, 1, 0, 0, 0, 100, 1.5);
  ...
  this.instance_12.setTransform(102.2, 85, 1, 1, 0, 0, 0, 120.2, 75);
  ...
  this.instance_13.setTransform(132, 207, 1, 1, 0, 0, 0, 150, 197);
  ...
  this.instance_14.setTransform(132, 207, 1, 1, 0, 0, 0, 150, 197);
  ...
  this.instance_15.setTransform(117, 207, 1, 1, 0, 0, 0, 150, 197);
 ...
 (lib.content = function(mode, startPosition, loop) {
  ...
  this.instance.parent = this;
  this.instance.setTransform(198.3, 18.3, 0.8333, 0.8333);
 ...
 p.nominalBounds = new cjs.Rectangle(-206.6, 0, 668.3, 250);
 ...
 p.nominalBounds = new cjs.Rectangle(125, 125, 357.5, 147.5);
 lib.properties = {
