(function(cjs, an) {
 ...
 (lib.t2_1 = function(mode, startPosition, loop) {
  ...
  this.cvr_t2.setTransform(386, 19.5, 0.5, 0.5);
  this.timeline.addTween(cjs.Tween.get(this.cvr_t2).wait(1));
  this.timeline.addTween(cjs.Tween.get(this.cvr_t2).wait(1));
 }).prototype = getMCSymbolPrototype(lib.t2_1, new cjs.Rectangle(384, 17.5, 71.89999999999998, 44.3), null);
 ...
 p.nominalBounds = new cjs.Rectangle(0, 0, 109, 41);
 (lib.t1 = function(mode, startPosition, loop) {
  this.initialize(mode, startPosition, loop, {});
  this.cvr_t1 = new lib.t1_t1_lact();
  this.cvr_t1.name = "cvr_t1";
  this.cvr_t1.parent = this;
  this.cvr_t1.setTransform(186, 20, 0.5, 0.5);
  this.timeline.addTween(cjs.Tween.get(this.cvr_t1).wait(1));
  this.timeline.addTween(cjs.Tween.get(this.cvr_t1).wait(1));
 }).prototype = getMCSymbolPrototype(lib.t1, new cjs.Rectangle(184, 18, 113.10000000000002, 47.3), null);
 ...
 (lib.l1 = function(mode, startPosition, loop) {
  this.initialize(mode, startPosition, loop, {});
  this.shape = new cjs.Shape();
  this.shape.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgTAsIgKAAIAAg7IAIAAIAAAsIAAAHIABgHIATgsIALAAIAAA7g");
  this.shape.setTransform(504.8, -8);
  this.shape_1 = new cjs.Shape();
  this.shape_1.graphics.f("#0C593C").s().p("AgVAdIAAgHIAEABQAAAAABAAQAAAAABgBQAAAAABAAQAAgBAAAAQACgCAAgFIABgOIAAgdIAhAAIAAA6IgIAAIAAgyIgRAAIAAAWQAAAOgDAHQgDAIgHAAIgFgBg");
  this.shape_1.setTransform(499.325, -7.975);
  this.shape_2 = new cjs.Shape();
  this.shape_2.graphics.f("#0C593C").s().p("AgLAcQgEgDgDgGQgCgIAAgLQAAgOAFgIQAFgIAKAAQAVAAAAAeQAAALgCAIQgDAGgEADQgGADgGAAQgGAAgFgDgAgGgVQgDADgBAFQgBAGgBAIIABAMQACAFADADQADADADAAQAEAAADgDQADgDABgFIABgMIgBgOQgBgFgDgDQgCgCgFAAQgDAAgDACg");
  this.shape_2.setTransform(494.55, -8);
  this.shape_3 = new cjs.Shape();
  this.shape_3.graphics.f("#0C593C").s().p("");
  this.shape_3.setTransform(489.6, -8.925);
  this.shape_4 = new cjs.Shape();
  this.shape_4.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgTAsIgKAAIAAg7IAIAAIAAAsIAAAHIABgHIATgsIALAAIAAA7g");
  this.shape_4.setTransform(482.3, -8);
  this.shape_5 = new cjs.Shape();
  this.shape_5.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgSAsIgKAAIAAg7IAIAAIAAAsIgBAHIACgHIASgsIAKAAIAAA7g");
  this.shape_5.setTransform(474.7, -8);
  this.shape_6 = new cjs.Shape();
  this.shape_6.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgSAsIgKAAIAAg7IAHAAIAAAsIAAAHIACgHIASgsIALAAIAAA7g");
  this.shape_6.setTransform(469.55, -8);
  this.shape_7 = new cjs.Shape();
  this.shape_7.graphics.f("#0C593C").s().p("AALAeIAAgcIgUAAIAAAcIgJAAIAAg7IAJAAIAAAZIAUAAIAAgZIAIAAIAAA7g");
  this.shape_7.setTransform(464.425, -8);
  this.shape_8 = new cjs.Shape();
  this.shape_8.graphics.f("#0C593C").s().p("");
  this.shape_8.setTransform(459.65, -8);
  this.shape_9 = new cjs.Shape();
  this.shape_9.graphics.f("#0C593C").s().p("AgRAeIAAg7IASAAQAHAAAEAFQAFADAAAHQAAAFgDAEQgCAEgFAAIAAABQAFAAADAEQADAEAAAFQAAAFgCAEQgCAEgDACQgEACgDAAgAgJAWIAJAAQAFABACgDQADgDAAgFQAAgEgDgDQgCgDgFABIgJAAgAgJgEIAJAAQAEABACgDQACgCAAgFQAAgJgIAAIgJAAg");
  this.shape_9.setTransform(455.275, -8);
  this.shape_10 = new cjs.Shape();
  this.shape_10.graphics.f("#0C593C").s().p("AgKAcQgFgDgDgGQgCgIAAgLQAAgOAFgIQAFgIAKAAQAVAAAAAeQAAALgDAIQgCAGgEADQgGADgGAAQgGAAgEgDgAgHgVQgCADgBAFQgCAGABAIIABAMQABAFACADQADADAEAAQAEAAADgDQADgDABgFIABgMIgBgOQgBgFgDgDQgDgCgEAAQgEAAgDACg");
  this.shape_10.setTransform(450.25, -8);
  this.shape_11 = new cjs.Shape();
  this.shape_11.graphics.f("#0C593C").s().p("");
  this.shape_11.setTransform(445.5, -8);
  this.shape_12 = new cjs.Shape();
  this.shape_12.graphics.f("#0C593C").s().p("");
  this.shape_12.setTransform(441.15, -8);
  this.shape_13 = new cjs.Shape();
  this.shape_13.graphics.f("#0C593C").s().p("AgTAoIAAhNIAIAAIAAAGIABAAQABgEADgCQAEgCADAAQATAAAAAeIgBAMIgDAKQgCAEgEACQgEADgFAAQgDAAgDgCQgDgCgCgEIAAAagAgIgZQgCAGAAALIAAALQABAFACADQADAEAEAAQAGAAADgGQACgHAAgLQAAgXgLAAQgGAAgCAHg");
  this.shape_13.setTransform(436.45, -7.075);
  this.shape_14 = new cjs.Shape();
  this.shape_14.graphics.f("#0C593C").s().p("");
  this.shape_14.setTransform(431.4, -8.925);
  this.shape_15 = new cjs.Shape();
  this.shape_15.graphics.f("#0C593C").s().p("AgKAcQgFgDgCgGQgDgIAAgLQAAgOAFgIQAFgIAKAAQAVAAAAAeQAAALgDAIQgCAGgFADQgEADgHAAQgGAAgEgDgAgHgVQgCADgBAFQgBAGAAAIIABAMQABAFACADQADADAEAAQAFAAADgDQACgDABgFIABgMIgBgOQgBgFgDgDQgCgCgFAAQgEAAgDACg");
  this.shape_15.setTransform(426.55, -8);
  this.shape_16 = new cjs.Shape();
  this.shape_16.graphics.f("#0C593C").s().p("AgLAcQgEgDgDgGQgCgIAAgLQAAgOAFgIQAFgIAKAAQAVAAAAAeQAAALgDAIQgCAGgEADQgGADgGAAQgGAAgFgDgAgHgVQgCADgBAFQgCAGABAIIAAAMQACAFACADQADADAEAAQAEAAADgDQADgDABgFIABgMIgBgOQgBgFgDgDQgDgCgEAAQgEAAgDACg");
  this.shape_16.setTransform(421.45, -8);
  this.shape_17 = new cjs.Shape();
  this.shape_17.graphics.f("#0C593C").s().p("");
  this.shape_17.setTransform(416.7, -8);
  this.shape_18 = new cjs.Shape();
  this.shape_18.graphics.f("#0C593C").s().p("");
  this.shape_18.setTransform(412.35, -8);
  this.shape_19 = new cjs.Shape();
  this.shape_19.graphics.f("#0C593C").s().p("AgOAeIAAg7IAdAAIAAAIIgVAAIAAAzg");
  this.shape_19.setTransform(408.6, -8);
  this.shape_20 = new cjs.Shape();
  this.shape_20.graphics.f("#0C593C").s().p("AgEAIQAEgCAAgHIgEAAIAAgLIAJAAIAAAMQAAAEgDAEQgCAEgEABg");
  this.shape_20.setTransform(402.725, -4.8);
  this.shape_21 = new cjs.Shape();
  this.shape_21.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgTAsIgKAAIAAg7IAIAAIAAAsIAAAHIABgHIATgsIAKAAIAAA7g");
  this.shape_21.setTransform(398.95, -8);
  this.shape_22 = new cjs.Shape();
  this.shape_22.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgSAsIgKAAIAAg7IAIAAIAAAsIgBAHIACgHIASgsIAKAAIAAA7g");
  this.shape_22.setTransform(393.8, -8);
  this.shape_23 = new cjs.Shape();
  this.shape_23.graphics.f("#0C593C").s().p("AgDAeIAAgzIgQAAIAAgIIAnAAIAAAIIgQAAIAAAzg");
  this.shape_23.setTransform(389.25, -8);
  this.shape_24 = new cjs.Shape();
  this.shape_24.graphics.f("#0C593C").s().p("AgTAmIAAgHQADABADAAQAEAAACgDQADgDABgGIgSg7IAIAAIANAvIABAAIANgvIAIAAIgSA7IgEAKQgBAEgDADQgEADgFgBIgGgBg");
  this.shape_24.setTransform(385.025, -7);
  this.shape_25 = new cjs.Shape();
  this.shape_25.graphics.f("#0C593C").s().p("AARAmIAAgQIghAAIAAAQIgIAAIAAgYIAFAAIAFgKIACgIIAAgNIAAgUIAfAAIAAAzIAGAAIAAAYgAgEgNQAAAKgBAEIgFANIAVAAIAAgrIgPAAg");
  this.shape_25.setTransform(380.225, -7.2);
  this.shape_26 = new cjs.Shape();
  this.shape_26.graphics.f("#0C593C").s().p("");
  this.shape_26.setTransform(375.45, -8);
  this.shape_27 = new cjs.Shape();
  this.shape_27.graphics.f("#0C593C").s().p("AgRAeIAAg7IASAAQAHAAAEAFQAFADAAAHQAAAFgDAEQgCAEgFAAIAAABQAFAAADAEQADAEAAAFQAAAFgCAEQgCAEgDACQgEACgDAAgAgJAWIAJAAQAFABACgDQADgDAAgFQAAgEgDgDQgCgDgFABIgJAAgAgJgEIAJAAQAEABACgDQACgCAAgFQAAgJgIAAIgJAAg");
  this.shape_27.setTransform(371.225, -8);
  this.shape_28 = new cjs.Shape();
  this.shape_28.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgTAsIgKAAIAAg7IAJAAIAAAsIgBAHIABgHIATgsIAKAAIAAA7g");
  this.shape_28.setTransform(363.75, -8);
  this.shape_29 = new cjs.Shape();
  this.shape_29.graphics.f("#0C593C").s().p("AgTAoIAAhNIAIAAIAAAGIABAAQABgEADgCQAFgCABAAQAUAAAAAeIgBAMIgDAKQgCAEgEACQgEADgFAAQgDAAgDgCQgDgCgCgEIAAAagAgIgZQgCAGAAALIAAALQABAFACADQADAEAEAAQAGAAACgGQADgHAAgLQAAgXgLAAQgGAAgCAHg");
  this.shape_29.setTransform(358.7, -7.075);
  this.shape_30 = new cjs.Shape();
  this.shape_30.graphics.f("#0C593C").s().p("AALAeIAAgzIgUAAIAAAzIgJAAIAAg7IAlAAIAAA7g");
  this.shape_30.setTransform(353.525, -8);
  this.shape_31 = new cjs.Shape();
  this.shape_31.graphics.f("#0C593C").s().p("AgDAeIAAgzIgQAAIAAgIIAnAAIAAAIIgQAAIAAAzg");
  this.shape_31.setTransform(346.6, -8);
  this.shape_32 = new cjs.Shape();
  this.shape_32.graphics.f("#0C593C").s().p("AgTAoIAAhNIAIAAIAAAGIABAAQABgEAEgCQADgCACAAQAUAAAAAeIgBAMIgDAKQgCAEgEACQgDADgGAAQgDAAgDgCQgDgCgCgEIAAAagAgJgZQgCAGABALIAAALQABAFACADQADAEAEAAQAGAAACgGQADgHAAgLQAAgXgLAAQgGAAgDAHg");
  this.shape_32.setTransform(342.25, -7.075);
  this.shape_33 = new cjs.Shape();
  this.shape_33.graphics.f("#0C593C").s().p("AgLAcQgEgDgDgGQgCgIAAgLQAAgOAFgIQAFgIAKAAQAVAAAAAeQAAALgCAIQgDAGgEADQgGADgGAAQgGAAgFgDgAgGgVQgDADgBAFQgBAGgBAIIABAMQACAFADADQADADADAAQAEAAADgDQADgDABgFIABgMIgBgOQgBgFgDgDQgDgCgEAAQgDAAgDACg");
  this.shape_33.setTransform(337.05, -8);
  this.shape_34 = new cjs.Shape();
  this.shape_34.graphics.f("#0C593C").s().p("");
  this.shape_34.setTransform(330.525, -8);
  this.shape_35 = new cjs.Shape();
  this.shape_35.graphics.f("#0C593C").s().p("AASAeIAAgzIgPAzIgFAAIgPgzIAAAzIgIAAIAAg7IANAAIALAnIABALIACgLIALgnIANAAIAAA7g");
  this.shape_35.setTransform(323.325, -8);
  this.shape_36 = new cjs.Shape();
  this.shape_36.graphics.f("#0C593C").s().p("AgKAcQgFgDgCgGQgDgIAAgLQAAgOAFgIQAFgIAKAAQAVAAAAAeQAAALgCAIQgDAGgFADQgEADgHAAQgGAAgEgDgAgHgVQgCADgBAFQgCAGAAAIIACAMQABAFACADQADADAEAAQAEAAAEgDQACgDABgFIABgMIgBgOQgBgFgDgDQgCgCgFAAQgEAAgDACg");
  this.shape_36.setTransform(317.55, -8);
  this.shape_37 = new cjs.Shape();
  this.shape_37.graphics.f("#0C593C").s().p("AAJAeIgNgeIgHAJIAAAVIgIAAIAAg7IAIAAIAAAcIAUgcIAKAAIgTAYIAUAjg");
  this.shape_37.setTransform(313.1, -8);
  this.shape_38 = new cjs.Shape();
  this.shape_38.graphics.f("#0C593C").s().p("AgLAbQgEgEgCgHQgBgGAAgJQAAgfATAAQAJAAAEAGQAFAGAAAIIgIAAQAAgNgKAAQgGAAgCAHQgCAHAAAKQAAAKACAHQACAGAGAAQAGAAACgEQACgEAAgHIAIAAQAAAKgEAFQgFAHgJAAQgHAAgFgEg");
  this.shape_38.setTransform(308.275, -8);
  this.shape_39 = new cjs.Shape();
  this.shape_39.graphics.f("#0C593C").s().p("AALAeIAAgsIABgIIgCAIIgTAsIgJAAIAAg7IAIAAIAAAsIgBAHIABgHIATgsIAKAAIAAA7g");
  this.shape_39.setTransform(303.45, -8);
  this.shape_40 = new cjs.Shape();
  this.shape_40.graphics.f("#0C593C").s().p("AARAmIAAgQIghAAIAAAQIgIAAIAAgYIAFAAIAFgKIACgIIAAgNIAAgUIAfAAIAAAzIAGAAIAAAYgAgEgNQAAAKgBAEIgFANIAVAAIAAgrIgPAAg");
  this.shape_40.setTransform(298.225, -7.2);
  this.shape_41 = new cjs.Shape();
  this.shape_41.graphics.f("#0C593C").s().p("AALAeIAAgaIgJAAIgLAaIgJAAIAMgaQgEgCgDgEQgDgEAAgGQAAgEACgFQACgDAEgCQAEgDAEAAIATAAIAAA7gAgFgTQgDACAAAGQAAAKAKAAIAJAAIAAgVIgJAAQgFABgCACg");
  this.shape_41.setTransform(290.625, -8);
  this.shape_42 = new cjs.Shape();
  this.shape_42.graphics.f("#0C593C").s().p("AgLAbQgEgEgCgHQgBgGAAgJQAAgfATAAQAJAAAEAGQAFAGAAAIIgIAAQAAgNgKAAQgGAAgCAHQgCAHAAAKQAAAKACAHQACAGAGAAQAGAAACgEQACgEAAgHIAIAAQAAAKgEAFQgFAHgJAAQgHAAgFgEg");
  this.shape_42.setTransform(286.425, -8);
  this.shape_43 = new cjs.Shape();
  this.shape_43.graphics.f("#0C593C").s().p("AgDAeIAAgzIgPAAIAAgIIAlAAIAAAIIgOAAIAAAzg");
  this.shape_43.setTransform(282.2, -8);
  this.shape_44 = new cjs.Shape();
  this.shape_44.graphics.f("#0C593C").s().p("AgJAcQgEgDgCgGQgDgIAAgLQAAgeASAAQAIAAAFAFQADAEABAHIABAPIgbAAIABANQABAFACACQACADAEAAQAKAAAAgOIAHAAQAAAGgBAFQgCAFgEADQgEACgGAAQgGAAgEgDgAgGgSQgDAFAAAIIATAAQAAgJgCgEQgBgFgHAAQgFAAgBAFg");
  this.shape_44.setTransform(278, -8);
  this.shape_45 = new cjs.Shape();
  this.shape_45.graphics.f("#0C593C").s().p("");
  this.shape_45.setTransform(273.55, -8);
  this.shape_46 = new cjs.Shape();
  this.shape_46.graphics.f("#0C593C").s().p("AgRAeIAAg7IASAAQAHAAAEAFQAFADAAAHQAAAFgDAEQgCAEgFAAIAAABQAFAAADAEQADAEAAAFQAAAFgCAEQgCAEgDACQgEACgDAAgAgJAWIAJAAQAFABACgDQADgDAAgFQAAgEgDgDQgCgDgFABIgJAAgAgJgEIAJAAQAEABACgDQACgCAAgFQAAgJgIAAIgJAAg");
  this.shape_46.setTransform(269.175, -8);
  this.shape_47 = new cjs.Shape();
  this.shape_47.graphics.f("#0C593C").s().p("AgJAcQgEgDgDgGQgCgIAAgLQABgeARAAQAIAAAFAFQADAEABAHIABAPIgbAAIABANQABAFACACQACADAEAAQAKAAgBgOIAIAAQAAAGgBAFQgCAFgEADQgEACgGAAQgGAAgEgDgAgHgSQgCAFAAAIIATAAQAAgJgCgEQgBgFgHAAQgFAAgCAFg");
  this.shape_47.setTransform(264.4, -8);
  this.shape_48 = new cjs.Shape();
  this.shape_48.graphics.f("#0C593C").s().p("AASAeIAAgzIgPAzIgFAAIgPgzIAAAzIgIAAIAAg7IANAAIALAnIABALIACgLIALgnIANAAIAAA7g");
  this.shape_48.setTransform(258.975, -8);
  this.shape_49 = new cjs.Shape();
  this.shape_49.graphics.f("#0C593C").s().p("AgTAmIAAgHQADABADAAQAEAAACgDQADgDABgGIgSg7IAIAAIANAvIABAAIANgvIAIAAIgSA7IgEAKQgBAEgDADQgEADgFgBIgGgBg");
  this.shape_49.setTransform(253.425, -7);
  this.shape_50 = new cjs.Shape();
  this.shape_50.graphics.f("#0C593C").s().p("");
  this.shape_50.setTransform(249.05, -8);
  this.shape_51 = new cjs.Shape();
  this.shape_51.graphics.f("#0C593C").s().p("");
  this.shape_51.setTransform(244.7, -8);
  this.shape_52 = new cjs.Shape();
  this.shape_52.graphics.f("#0C593C").s().p("AgTAoIAAhNIAIAAIAAAGIABAAQABgEADgCQAFgCABAAQAUAAAAAeIgBAMIgDAKQgCAEgEACQgDADgGAAQgDAAgDgCQgDgCgCgEIAAAagAgJgZQgBAGAAALIAAALQABAFACADQACAEAFAAQAGAAACgGQADgHAAgLQAAgXgLAAQgGAAgDAHg");
  this.shape_52.setTransform(240, -7.075);
  this.shape_53 = new cjs.Shape();
  this.shape_53.graphics.f("#0C593C").s().p("AARAmIAAgQIghAAIAAAQIgIAAIAAgYIAFAAIAFgKIACgIIAAgNIAAgUIAfAAIAAAzIAGAAIAAAYgAgEgNQAAAKgBAEIgFANIAVAAIAAgrIgPAAg");
  this.shape_53.setTransform(234.725, -7.2);
  this.shape_54 = new cjs.Shape();
  this.shape_54.graphics.f("#0C593C").s().p("AgLAcQgEgDgCgGQgDgIAAgLQAAgOAFgIQAFgIAKAAQAVAAAAAeQAAALgCAIQgDAGgEADQgFADgHAAQgGAAgFgDgAgGgVQgDADgBAFQgBAGgBAIIABAMQACAFADADQADADADAAQAEAAADgDQADgDABgFIABgMIgBgOQgBgFgDgDQgDgCgEAAQgDAAgDACg");
  this.shape_54.setTransform(229.6, -8);
  this.shape_55 = new cjs.Shape();
  this.shape_55.graphics.f("#0C593C").s().p("AAPAoIAAhHIgdAAIAABHIgJAAIAAhPIAvAAIAABPg");
  this.shape_55.setTransform(223.925, -9);
  this.shape_56 = new cjs.Shape();
  this.shape_56.graphics.f("#0C593C").s().p("AAAAFIgHAKIgFgDIAJgKIgMgDIACgFIALAFIAAgOIAFAAIAAANIALgEIACAFIgMADIAIAKIgEAEg");
  this.shape_56.setTransform(218.25, -11.4);
  this.timeline.addTween(cjs.Tween.get({}).to({
   state: [{
    t: this.shape_56
   }, {
  ...
  this.shape_57 = new cjs.Shape();
  this.shape_57.graphics.f("rgba(216,247,139,0.698)").s().p("Eg43ABLIAAiVMBxvAAAIAACVg");
  this.shape_57.setTransform(364, -7.5);
  this.timeline.addTween(cjs.Tween.get(this.shape_57).wait(1));
 }).prototype = getMCSymbolPrototype(lib.l1, new cjs.Rectangle(0, -17, 728, 17), null);
 ...
 (lib.txt02_1 = function(mode, startPosition, loop) {
  ...
  var mask = new cjs.Shape();
  mask._off = true;
  mask.graphics.p("AAtG6IAAnyMAk4AAAIAAHyg");
  mask.setTransform(240.5, 44.25);
  ...
  var mask_1 = new cjs.Shape();
  mask_1._off = true;
  mask_1.graphics.p("AAtD6IAAnzMAk4AAAIAAHzg");
  mask_1.setTransform(240.5, 13.5);
 ...
 p.nominalBounds = new cjs.Rectangle(354, 17.5, 101.89999999999998, 44.3);
 ...
 (lib.txt01 = function(mode, startPosition, loop) {
  ...
  var mask = new cjs.Shape();
  mask._off = true;
  mask.graphics.p("AlTFOIAAj4IdNAAIAAD4g");
  mask.setTransform(153.0246, 33.3873);
  ...
  var mask_1 = new cjs.Shape();
  mask_1._off = true;
  mask_1.graphics.p("AlTDSIAAj3IdNAAIAAD3g");
  mask_1.setTransform(153.0246, 21.0373);
 ...
 p.nominalBounds = new cjs.Rectangle(154, 18, 143.10000000000002, 47.3);
 ...
 (lib.content = function(mode, startPosition, loop) {
  ...
  this.instance_2._off = true;
  this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(105).to({
   _off: false
  }, 0).wait(75).to({
   startPosition: 34
  }, 0).to({
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(380).to({
   _off: false
  }, 0).to({
   alpha: 1
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(364).to({
   _off: false
  }, 0).to({
   alpha: 1
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(295).to({
   _off: false
  }, 0).to({
   _off: true
  }, 85).wait(75));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(285).to({
   _off: false
  }, 0).to({
   x: 477.7
  }, 14, cjs.Ease.get(1)).to({
  ...
  var mask = new cjs.Shape();
  mask._off = true;
  var mask_graphics_300 = new cjs.Graphics().p("AZQDvQgQgQAAgXQAAgXAQgQQAQgQAXAAQAXAAAQAQQAQAQAAAXQAAAXgQAQQgQAQgXAAQgXAAgQgQg");
  var mask_graphics_301 = new cjs.Graphics().p("AYgD3QgcgcAAgnQAAgnAcgcQAcgcAnAAQAnAAAcAcQAcAcAAAnQAAAngcAcQgcAcgnAAQgnAAgcgcg");
  var mask_graphics_302 = new cjs.Graphics().p("AXzD/QgmgnAAg2QAAg3AmgnQAngmA2AAQA3AAAnAmQAmAnAAA3QAAA2gmAnQgnAmg3AAQg2AAgngmg");
  var mask_graphics_303 = new cjs.Graphics().p("AXKEGQgwgxAAhFQAAhEAwgxQAxgvBEAAQBFAAAxAvQAwAxAABEQAABFgwAxQgxAwhFAAQhEAAgxgwg");
  var mask_graphics_304 = new cjs.Graphics().p("AWlEMQg6g5AAhSQAAhSA6g4QA5g6BSAAQBSAAA5A6QA6A4AABSQAABSg6A5Qg5A6hSAAQhSAAg5g6g");
  var mask_graphics_305 = new cjs.Graphics().p("AWDESQhChCAAhdQAAhdBChBQBChCBdAAQBdAABCBCQBCBBAABdQAABdhCBCQhCBChdAAQhdAAhChCg");
  var mask_graphics_306 = new cjs.Graphics().p("AVkEXQhJhJAAhoQAAhmBJhKQBKhJBnAAQBoAABJBJQBKBKAABmQAABohKBJQhJBKhoAAQhnAAhKhKg");
  var mask_graphics_307 = new cjs.Graphics().p("AVJEcQhPhQAAhxQAAhwBPhQQBQhPBxAAQBxAABQBPQBQBQAABwQAABxhQBQQhQBQhxAAQhxAAhQhQg");
  var mask_graphics_308 = new cjs.Graphics().p("AUyEgQhVhWAAh4QAAh4BVhWQBWhVB5AAQB4AABWBVQBVBWAAB4QAAB4hVBWQhWBVh4AAQh5AAhWhVg");
  var mask_graphics_309 = new cjs.Graphics().p("AUfEjQhbhaAAiAQAAh+BbhaQBahbB/AAQCAAABaBbQBaBaAAB+QAACAhaBaQhaBaiAAAQh/AAhahag");
  var mask_graphics_310 = new cjs.Graphics().p("AUPEmQhfheAAiFQAAiEBfheQBehfCFAAQCFAABeBfQBeBeAACEQAACFheBeQheBeiFAAQiFAAheheg");
  var mask_graphics_311 = new cjs.Graphics().p("AUCEoQhhhhAAiJQAAiJBhhhQBhhhCKAAQCJAABhBhQBhBhAACJQAACJhhBhQhhBhiJAAQiKAAhhhhg");
  var mask_graphics_312 = new cjs.Graphics().p("AT5EqQhjhkAAiMQAAiMBjhjQBjhjCNAAQCMAABkBjQBjBjAACMQAACMhjBkQhkBjiMAAQiNAAhjhjg");
  var mask_graphics_313 = new cjs.Graphics().p("AT0ErQhlhlAAiOQAAiOBlhkQBkhlCPAAQCOAABlBlQBkBkAACOQAACOhkBlQhlBkiOAAQiPAAhkhkg");
  var mask_graphics_314 = new cjs.Graphics().p("ATyErQhlhlAAiPQAAiOBlhlQBlhlCPAAQCPAABlBlQBlBlAACOQAACPhlBlQhlBliPAAQiPAAhlhlg");
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(300).to({
   _off: false
  }, 0).to({
   _off: true
  }, 80).wait(75));
  ...
  this.instance_9.setTransform(336.65, 44.8, 0.0529, 0.0529, 0, 0, 0, 151.2, 151.2);
  this.instance_9._off = true;
  this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(295).to({
   _off: false
  }, 0).to({
   regX: 151.1,
   regY: 151,
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(290).to({
   _off: false
  }, 0).to({
   regX: 151.7,
   regY: 151.2,
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(277).to({
   _off: false
  }, 0).to({
   alpha: 1
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(205).to({
   _off: false
  }, 0).to({
   alpha: 1
  }, 14, cjs.Ease.get(1)).to({
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(185).to({
   _off: false
  }, 0).to({
   x: 480
  }, 14, cjs.Ease.get(1)).to({
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(195).to({
   _off: false
  }, 0).to({
   _off: true
  }, 98).wait(162));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(190).to({
   _off: false
  }, 0).to({
   regX: 150.8,
   regY: 150.7,
  ...
  var mask_1 = new cjs.Shape();
  mask_1._off = true;
  var mask_1_graphics_200 = new cjs.Graphics().p("Ab7DeQgTgTAAgcQAAgbATgUQAUgTAbAAQAbAAAUATQATAUAAAbQAAAcgTATQgUATgbAAQgbAAgUgTg");
  var mask_1_graphics_201 = new cjs.Graphics().p("Aa3DqQgkgkAAgzQAAgzAkgkQAkgjAzAAQAzAAAjAjQAkAkAAAzQAAAzgkAkQgjAjgzAAQgzAAgkgjg");
  var mask_1_graphics_202 = new cjs.Graphics().p("AZ4D0QgzgzAAhIQAAhIAzgyQAzg0BJAAQBIAAAzA0QAzAyAABIQAABIgzAzQgzAzhIAAQhJAAgzgzg");
  var mask_1_graphics_203 = new cjs.Graphics().p("AY/D+QhChBAAhcQAAhcBChAQBBhBBcAAQBcAABBBBQBBBAAABcQAABchBBBQhBBBhcAAQhcAAhBhBg");
  var mask_1_graphics_204 = new cjs.Graphics().p("AYKEHQhOhOAAhuQAAhtBOhOQBOhOBuAAQBuAABOBOQBOBOAABtQAABuhOBOQhOBOhuAAQhuAAhOhOg");
  var mask_1_graphics_205 = new cjs.Graphics().p("AXaEPQhahZAAh/QAAh+BahZQBZhaB/AAQB/AABZBaQBaBZAAB+QAAB/haBZQhZBah/AAQh/AAhZhag");
  var mask_1_graphics_206 = new cjs.Graphics().p("AWvEWQhkhjAAiOQAAiMBkhkQBkhkCNAAQCNAABkBkQBkBkAACMQAACOhkBjQhkBkiNAAQiNAAhkhkg");
  var mask_1_graphics_207 = new cjs.Graphics().p("AWJEdQhthtAAiaQAAiaBthtQBthtCbAAQCaAABtBtQBtBtAACaQAACahtBtQhtBtiaAAQibAAhthtg");
  var mask_1_graphics_208 = new cjs.Graphics().p("AVpEiQh1h1AAilQAAikB1h1QB1h1ClAAQClAAB1B1QB1B1AACkQAAClh1B1Qh1B1ilAAQilAAh1h1g");
  var mask_1_graphics_209 = new cjs.Graphics().p("AVNErQh8h8AAivQAAiuB8h8QB8h7CvAAQCuAAB8B7QB8B8AACuQAACvh8B8Qh8B7iuAAQivAAh8h7g");
  var mask_1_graphics_210 = new cjs.Graphics().p("AU2E4QiBiBAAi3QAAi2CBiBQCBiBC3AAQC3AACBCBQCBCBAAC2QAAC3iBCBQiBCBi3AAQi3AAiBiBg");
  var mask_1_graphics_211 = new cjs.Graphics().p("AUlFCQiGiFAAi9QAAi8CGiFQCFiFC9AAQC9AACFCFQCFCFAAC8QAAC9iFCFQiFCFi9AAQi9AAiFiFg");
  var mask_1_graphics_212 = new cjs.Graphics().p("AUYFJQiIiIAAjBQAAjACIiIQCJiJDBAAQDBAACICJQCICIAADAQAADBiICIQiICJjBAAQjBAAiJiJg");
  var mask_1_graphics_213 = new cjs.Graphics().p("AURFOQiLiKAAjEQAAjDCLiKQCKiKDDAAQDEAACKCKQCLCKAADDQAADEiLCKQiKCKjEAAQjDAAiKiKg");
  var mask_1_graphics_214 = new cjs.Graphics().p("AUNFPQiKiLAAjEQAAjDCKiLQCLiLDFAAQDEAACLCLQCLCLAADDQAADEiLCLQiLCLjEAAQjFAAiLiLg");
  ...
  this.instance_16.setTransform(376.85, 41.6, 0.6628, 0.6635, 0, 0, 0, 58.4, 52.2);
  this.instance_16._off = true;
  var maskedShapeInstanceList = [this.instance_16];
  for (var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
   maskedShapeInstanceList[shapedInstanceItr].mask = mask_1;
  }
  this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(200).to({
   _off: false
  }, 0).to({
   _off: true
  }, 93).wait(162));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(195).to({
   _off: false
  }, 0).to({
   regX: 153.5,
   regY: 153.7,
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_18).wait(180).to({
   _off: false
  }, 0).to({
   alpha: 1
  }, 14, cjs.Ease.get(1)).to({
  ...
  this.instance_22.setTransform(141.5, 104.8, 1, 1, 0, 0, 0, 141.5, 14.8);
  ...
  this.instance_25.setTransform(417.35, 43.45, 0.0394, 0.0394, 0, 0, 0, 151, 151);
  ...
  var mask_2 = new cjs.Shape();
  mask_2._off = true;
  var mask_2_graphics_30 = new cjs.Graphics().p("EAmGADVQgPgPAAgUQAAgVAPgPQAPgOAUAAQAVAAAPAOQAOAPAAAVQAAAUgOAPQgPAPgVAAQgUAAgPgPg");
  var mask_2_graphics_31 = new cjs.Graphics().p("EAlYADcQgagZAAglQAAgkAagaQAagaAkAAQAkAAAaAaQAaAaAAAkQAAAlgaAZQgaAagkAAQgkAAgagag");
  var mask_2_graphics_32 = new cjs.Graphics().p("EAktADjQgkgkAAgzQAAgzAkgkQAkgkAzAAQAzAAAkAkQAkAkAAAzQAAAzgkAkQgkAkgzAAQgzAAgkgkg");
  var mask_2_graphics_33 = new cjs.Graphics().p("EAkGADpQgtgtAAhBQAAhAAtgtQAugtBAAAQBAAAAuAtQAtAtAABAQAABBgtAtQguAuhAAAQhAAAgugug");
  var mask_2_graphics_34 = new cjs.Graphics().p("EAjiADvQg2g2AAhNQAAhMA2g1QA3g2BMAAQBNAAA2A2QA2A1AABMQAABNg2A2Qg2A2hNAAQhMAAg3g2g");
  var mask_2_graphics_35 = new cjs.Graphics().p("EAjCAD0Qg+g+AAhYQAAhXA+g9QA+g+BYAAQBXAAA+A+QA+A9AABXQAABYg+A+Qg+A+hXAAQhYAAg+g+g");
  var mask_2_graphics_36 = new cjs.Graphics().p("EAilAD4QhFhEAAhiQAAhgBFhFQBFhFBhAAQBiAABFBFQBFBFAABgQAABihFBEQhFBFhiAAQhhAAhFhFg");
  var mask_2_graphics_37 = new cjs.Graphics().p("EAiMAD8QhLhLAAhqQAAhpBLhLQBLhLBqAAQBqAABLBLQBLBLAABpQAABqhLBLQhLBLhqAAQhqAAhLhLg");
  var mask_2_graphics_38 = new cjs.Graphics().p("EAh1AEAQhQhRAAhxQAAhxBQhQQBRhRByAAQBxAABRBRQBQBQAABxQAABxhQBRQhRBQhxAAQhyAAhRhQg");
  var mask_2_graphics_39 = new cjs.Graphics().p("EAhjAEDQhVhVAAh4QAAh3BVhVQBVhVB4AAQB4AABVBVQBVBVAAB3QAAB4hVBVQhVBVh4AAQh4AAhVhVg");
  var mask_2_graphics_40 = new cjs.Graphics().p("EAhTAEFQhYhYAAh+QAAh8BYhZQBZhYB9AAQB+AABYBYQBZBZAAB8QAAB+hZBYQhYBZh+AAQh9AAhZhZg");
  var mask_2_graphics_41 = new cjs.Graphics().p("EAhHAEHQhbhbAAiCQAAiABbhcQBchbCBAAQCCAABbBbQBcBcAACAQAACChcBbQhbBciCAAQiBAAhchcg");
  var mask_2_graphics_42 = new cjs.Graphics().p("EAg/AEIQhehdAAiEQAAiEBehdQBdheCFAAQCEAABeBeQBdBdAACEQAACEhdBdQheBeiEAAQiFAAhdheg");
  var mask_2_graphics_43 = new cjs.Graphics().p("EAg6AEJQhfhfAAiGQAAiFBfheQBfhfCGAAQCGAABeBfQBfBeAACFQAACGhfBfQheBfiGAAQiGAAhfhfg");
  var mask_2_graphics_44 = new cjs.Graphics().p("EAg5AEJQhfhfAAiHQAAiGBfhfQBfhfCHAAQCHAABfBfQBfBfAACGQAACHhfBfQhfBfiHAAQiHAAhfhfg");
  ...
  this.instance_26.setTransform(500.65, 39.85, 0.582, 0.5815, 0, 0, 0, 57.4, 58.3);
  ...
  this.instance_27.setTransform(499.95, 40.6, 0.0366, 0.0366, 0, 0, 0, 151.5, 151.5);
  ...
  mask_3._off = true;
  var mask_3_graphics_10 = new cjs.Graphics().p("AZwDmQgMgMAAgSQAAgRAMgNQANgMARAAQASAAAMAMQANANAAARQAAASgNAMQgMANgSAAQgRAAgNgNg");
  var mask_3_graphics_11 = new cjs.Graphics().p("AY+DvQgYgZAAgiQAAgjAYgZQAZgYAjAAQAiAAAZAYQAYAZAAAjQAAAigYAZQgZAYgiAAQgjAAgZgYg");
  var mask_3_graphics_12 = new cjs.Graphics().p("AYQD2QgjgjAAgzQAAgyAjgkQAkgjAyAAQAzAAAjAjQAkAkAAAyQAAAzgkAjQgjAkgzAAQgyAAgkgkg");
  var mask_3_graphics_13 = new cjs.Graphics().p("AXmD9QgugtAAhBQAAhBAuguQAugtBBAAQBBAAAtAtQAuAuAABBQAABBguAtQgtAuhBAAQhBAAgugug");
  var mask_3_graphics_14 = new cjs.Graphics().p("AXAEEQg4g3AAhOQAAhOA4g2QA3g4BOAAQBOAAA3A4QA3A2AABOQAABOg3A3Qg3A3hOAAQhOAAg3g3g");
  var mask_3_graphics_15 = new cjs.Graphics().p("AWdEKQhAhAAAhaQAAhaBAg+QA/hABaAAQBaAABABAQA/A+AABaQAABag/BAQhAA/haAAQhaAAg/g/g");
  var mask_3_graphics_16 = new cjs.Graphics().p("AV9EPQhHhHAAhlQAAhkBHhHQBHhHBlAAQBlAABHBHQBHBHAABkQAABlhHBHQhHBHhlAAQhlAAhHhHg");
  var mask_3_graphics_17 = new cjs.Graphics().p("AViETQhOhNAAhuQAAhtBOhOQBOhOBuAAQBuAABNBOQBOBOAABtQAABuhOBNQhNBOhuAAQhuAAhOhOg");
  var mask_3_graphics_18 = new cjs.Graphics().p("AVKEXQhUhTAAh2QAAh2BUhTQBThUB3AAQB2AABTBUQBUBTAAB2QAAB2hUBTQhTBUh2AAQh3AAhThUg");
  var mask_3_graphics_19 = new cjs.Graphics().p("AU2EbQhZhZAAh9QAAh8BZhYQBYhZB9AAQB9AABZBZQBYBYAAB8QAAB9hYBZQhZBYh9AAQh9AAhYhYg");
  var mask_3_graphics_20 = new cjs.Graphics().p("AUlEeQhchdAAiDQAAiCBchcQBchcCDAAQCDAABdBcQBcBcAACCQAACDhcBdQhdBciDAAQiDAAhchcg");
  var mask_3_graphics_21 = new cjs.Graphics().p("AUYEgQhfhgAAiHQAAiGBfhgQBghfCHAAQCHAABgBfQBfBgAACGQAACHhfBgQhgBfiHAAQiHAAhghfg");
  var mask_3_graphics_22 = new cjs.Graphics().p("AUPEhQhihiAAiKQAAiJBihiQBihiCKAAQCKAABiBiQBiBiAACJQAACKhiBiQhiBiiKAAQiKAAhihig");
  var mask_3_graphics_23 = new cjs.Graphics().p("AUJEiQhjhjAAiMQAAiLBjhkQBkhjCMAAQCMAABjBjQBjBkAACLQAACMhjBjQhjBjiMAAQiMAAhkhjg");
  var mask_3_graphics_24 = new cjs.Graphics().p("AUIEjQhkhjAAiNQAAiMBkhjQBjhkCNAAQCNAABkBkQBjBjAACMQAACNhjBjQhkBkiNAAQiNAAhjhkg");
  ...
  this.instance_28.setTransform(339.15, 44.1, 0.488, 0.4875, 0, 0, 0, 72, 72);
  ...
  this.instance_29.setTransform(339.8, 44.85, 0.0386, 0.0386, 0, 0, 0, 150.4, 150.4);
  ...
  this.instance_30.setTransform(238.25, 40, 0.0502, 0.0502, 0, 0, 0, 149.5, 149.5);
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_31).wait(455));
 }).prototype = p = new cjs.MovieClip();
