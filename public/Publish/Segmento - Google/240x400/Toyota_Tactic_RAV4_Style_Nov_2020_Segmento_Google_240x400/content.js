(function(cjs, an) {
 ...
 p.nominalBounds = new cjs.Rectangle(0, 0, 215, 405);
 ...
 (lib.content = function(mode, startPosition, loop) {
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(375));
  ...
  this.timeline.addTween(cjs.Tween.get(this.instance_20).wait(375));
 }).prototype = p = new cjs.MovieClip();
